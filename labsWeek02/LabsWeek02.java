...
System.out.println(age >= 16);
	...
	int thirstLevel = 3;
		...
		double billTotal = 666;
		double adjustedBill = billTotal - loyaltyMemberDiscount * billTotal; 
		...
		System.out.println(adjustedBill + " " + loyaltyMemberStatus);
